...
for i in range (1992,2017):
    ...
    with open(file_path, 'r') as input_file:
        ...
        for row in reader:
            ...
            elif (row[sex_index] == '2'):
                if (row[death_month_index] == '0'):
                    non_fatal_female += 1
                else: fatal_female += 1

print('total fatal count from 1992 to 2016 for males is ' + str(fatal_male))
print('total non-fatal count from 1992 to 2016 for males is ' + str(non_fatal_male))        
print('total fatal count from 1992 to 2016 for females is ' + str(fatal_female))
print('total non-fatal count from 1992 to 2016 for females is ' + str(non_fatal_female))
